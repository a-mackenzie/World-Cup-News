...
public class SettingsActivity extends AppCompatActivity {
    ...
    public static class ArticlePreferenceFragment extends PreferenceFragment implements Preference.OnPreferenceChangeListener {
        ...
        public void onCreate(Bundle savedInstanceState) {
            ...
            Preference dateFrom = findPreference(getString(R.string.settingsDateFromKey));
            bindPreferenceSummaryToValue(dateFrom);

            Preference dateTo = findPreference(getString(R.string.settingsDateToKey));
            bindPreferenceSummaryToValue(dateTo);
